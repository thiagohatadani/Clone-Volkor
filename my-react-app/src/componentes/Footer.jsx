  ...
  return (
    <footer>
      ...
      >
        ...
        <p className="pt-6  relative z-10">Inspirado no modelo de <a href="https://jkdesign.fr/" target="_blank">JKDESIGN</a></p>
        <p className=" pb-20  relative z-10">© 2025. Replicado por <a href="https://github.com/thiagohatadani" target="_blank">Thiago Hatadani</a></p>
      </div>
    </footer>
  );
};
